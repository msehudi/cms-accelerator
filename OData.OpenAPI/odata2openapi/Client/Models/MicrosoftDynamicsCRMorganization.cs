...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMorganization
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMorganization(int? maxverboseloggingsynccycles = default(int?), int? recurrenceexpansionjobbatchsize = default(int?), string privilegeusergroupid = default(string), int? expiresubscriptionsindays = default(int?), bool? showkbarticledeprecationnotification = default(bool?), bool? globalhelpurlenabled = default(bool?), string widgetproperties = default(string), string _defaultmobileofflineprofileidValue = default(string), bool? taskbasedflowenabled = default(bool?), bool? iscontextualhelpenabled = default(bool?), bool? isquickcreateenabledforopportunityclose = default(bool?), string ispdfgenerationenabled = default(string), bool? generatealertsforinformation = default(bool?), bool? enablesmartmatching = default(bool?), string orderprefix = default(string), string currencysymbol = default(string), bool? bounddashboarddefaultcardexpanded = default(bool?), string releasewavename = default(string), bool? allowwebexcelexport = default(bool?), string highcontrastthemedata = default(string), string caseprefix = default(string), int? longdateformatcode = default(int?), bool? usepositionhierarchy = default(bool?), int? trackingtokenidbase = default(int?), string defaultemailsettings = default(string), string hashfilterkeywords = default(string), bool? generatealertsforwarnings = default(bool?), int? maximumentitieswithactivesla = default(int?), bool? newsearchexperienceenabled = default(bool?), string privreportinggroupid = default(string), string invoiceprefix = default(string), string campaignprefix = default(string), bool? isfiscalperiodmonthbased = default(bool?), int? mailboxintermittentissueminrange = default(int?), bool? isassignedtaskssyncenabled = default(bool?), bool? issopintegrationenabled = default(bool?), bool? ismobileclientondemandsyncenabled = default(bool?), bool? allowautounsubscribeacknowledgement = default(bool?), bool? ismsteamssettingchangedbyuser = default(bool?), bool? enableimmersiveskypeintegration = default(bool?), bool? isgeospatialazuremapsintegrationenabled = default(bool?), bool? servestaticresourcesfromazurecdn = default(bool?), bool? isautodatacaptureenabled = default(bool?), int? currentparsedtablenumber = default(int?), bool? isluisenabledford365bot = default(bool?), string blockedattachments = default(string), bool? useinbuiltrulefordefaultpricelistselection = default(bool?), int? maxslaitemspersla = default(int?), bool? isconflictdetectionenabledformobileclient = default(bool?), string businesscardoptions = default(string), int? goalrollupfrequency = default(int?), string parsedtableprefix = default(string), bool? isreadauditenabled = default(bool?), bool? appointmentricheditorexperience = default(bool?), int? maxconditionsformobileofflinefilters = default(int?), bool? enableunifiedinterfaceshellrefresh = default(bool?), int? minoutlooksyncinterval = default(int?), bool? requireapprovalforqueueemail = default(bool?), bool? isrichtextnotesenabled = default(bool?), bool? ismsteamscollaborationenabled = default(bool?), string categoryprefix = default(string), bool? iswriteinproductsallowed = default(bool?), int? recurrenceexpansionjobbatchinterval = default(int?), int? maxrecordsforlookupfilters = default(int?), int? sharepointdeploymenttype = default(int?), bool? isrelationshipinsightsenabled = default(bool?), int? emailsendpollingperiod = default(int?), string postmessagewhitelistdomains = default(string), int? localeid = default(int?), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), bool? isduplicatedetectionenabledforonlinecreateupdate = default(bool?), bool? socialinsightstermsaccepted = default(bool?), string contentsecuritypolicyconfiguration = default(string), bool? isresourcebookingexchangesyncenabled = default(bool?), bool? displaynavigationtour = default(bool?), bool? isautosaveenabled = default(bool?), int? fiscalyearformatyear = default(int?), int? pinpointlanguagecode = default(int?), string tokenkey = default(string), bool? isenabledforallroles = default(bool?), bool? enablelpauthoring = default(bool?), int? mobileofflineminlicensetrial = default(int?), int? calendartype = default(int?), bool? officeappsautodeploymentenabled = default(bool?), bool? autoapplydefaultoncasecreate = default(bool?), bool? isnotesanalysisenabled = default(bool?), bool? iscontactmailingaddresssyncenabled = default(bool?), bool? ismailboxforcedunlockingenabled = default(bool?), bool? isexternalfilestorageenabled = default(bool?), int? mobileofflinesyncinterval = default(int?), int? tagmaxaggressivecycles = default(int?), string _createdbyValue = default(string), string _modifiedbyValue = default(string), bool? rendersecureiframeforemail = default(bool?), bool? ispresenceenabled = default(bool?), bool? allowoutlookscheduledsyncs = default(bool?), int? maximumdynamicpropertiesallowed = default(int?), string numbergroupformat = default(string), string entityimageid = default(string), int? trackingtokeniddigits = default(int?), bool? unresolveemailaddressifmultiplematch = default(bool?), int? defaultrecurrenceendrangetype = default(int?), string bulkoperationprefix = default(string), bool? oobpricecalculationenabled = default(bool?), int? futureexpansionwindow = default(int?), int? pastexpansionwindow = default(int?), int? maximumslakpiperentitywithactivesla = default(int?), System.DateTimeOffset? fiscalcalendarstart = default(System.DateTimeOffset?), string picture = default(string), bool? isdelveactionhubintegrationenabled = default(bool?), string azureschedulerjobcollectionname = default(string), bool? isofficegraphenabled = default(bool?), string orgdborgsettings = default(string), bool? isonedriveenabled = default(bool?), int? discountcalculationmethod = default(int?), bool? ismanualsalesforecastingenabled = default(bool?), int? mobileofflineminlicenseprod = default(int?), int? minaddressbooksyncinterval = default(int?), int? tracelogmaximumageindays = default(int?), int? goalrollupexpirytime = default(int?), bool? enforcereadonlyplugins = default(bool?), bool? ismsteamsusersyncenabled = default(bool?), bool? createproductswithoutparentinactivestate = default(bool?), byte[] entityimage = default(byte[]), bool? textanalyticsenabled = default(bool?), int? expirechangetrackingindays = default(int?), bool? usereadform = default(bool?), string basecurrencysymbol = default(string), bool? requireapprovalforuseremail = default(bool?), string fiscalyearperiodconnect = default(string), int? maxsupportedinternetexplorerversion = default(int?), bool? inactivitytimeoutenabled = default(bool?), string bingmapsapikey = default(string), bool? ismobileofflineenabled = default(bool?), bool? restrictstatusupdate = default(bool?), string sqlaccessgroupname = default(string), string externalpartycorrelationkeys = default(string), bool? getstartedpanecontentenabled = default(bool?), bool? istextwrapenabled = default(bool?), bool? ispricelistmandatory = default(bool?), string timeseparator = default(string), int? nexttrackingnumber = default(int?), string v3calloutconfighash = default(string), int? plugintracelogsetting = default(int?), int? yearstartweekcode = default(int?), int? syncoptinselectionstatus = default(int?), int? syncbulkoperationmaxlimit = default(int?), bool? allowofflinescheduledsyncs = default(bool?), int? basecurrencyprecision = default(int?), string delegatedadminuserid = default(string), string socialinsightsinstance = default(string), bool? ishierarchicalsecuritymodelenabled = default(bool?), int? currentimportsequencenumber = default(int?), bool? isuseraccessauditenabled = default(bool?), int? fiscalyearformatprefix = default(int?), bool? enablebingmapsintegration = default(bool?), int? maxuploadfilesize = default(int?), int? syncbulkoperationbatchsize = default(int?), int? timezoneruleversionnumber = default(int?), int? tagpollingperiod = default(int?), bool? suppresssla = default(bool?), string webresourcehash = default(string), string versionnumber = default(string), string kmsettings = default(string), bool? isemailmonitoringallowed = default(bool?), string schemanameprefix = default(string), bool? paipreviewscenarioenabled = default(bool?), bool? autoapplysla = default(bool?), System.DateTimeOffset? relevancesearchmodifiedon = default(System.DateTimeOffset?), int? incomingemailexchangeemailretrievalbatchsize = default(int?), bool? ismailboxinactivebackoffenabled = default(bool?), bool? cortanaproactiveexperienceenabled = default(bool?), string globalhelpurl = default(string), string supportuserid = default(string), bool? isappmode = default(bool?), bool? iscustomcontrolsincanvasappsenabled = default(bool?), string contractprefix = default(string), bool? allowautounsubscribe = default(bool?), string quoteprefix = default(string), string pmdesignator = default(string), int? auditretentionperiodv2 = default(int?), bool? ispreviewforautocaptureenabled = default(bool?), int? minofflinesyncinterval = default(int?), string numberformat = default(string), string systemuserid = default(string), bool? orginsightsenabled = default(bool?), int? maxactionstepsinbpf = default(int?), int? lookupresolvedelayms = default(int?), int? fiscalyeardisplaycode = default(int?), bool? isdisabled = default(bool?), bool? isplaybookenabled = default(bool?), bool? allowentityonlyaudit = default(bool?), bool? autoapplydefaultoncaseupdate = default(bool?), int? negativecurrencyformatcode = default(int?), bool? cascadestatusupdate = default(bool?), bool? powerbifeatureenabled = default(bool?), int? lookupcharactercountbeforeresolve = default(int?), bool? allowaddressbooksyncs = default(bool?), bool? notifymailboxownerofemailserverlevelalerts = default(bool?), bool? usequickfindviewforgridsearch = default(bool?), string organizationid = default(string), int? mailboxpermanentissueminrange = default(int?), bool? relevancesearchenabledbyplatform = default(bool?), bool? isexternalsearchindexenabled = default(bool?), bool? isfulltextsearchenabled = default(bool?), int? hashminaddresscount = default(int?), string clientfeatureset = default(string), int? weekstartdaycode = default(int?), string integrationuserid = default(string), string numberseparator = default(string), bool? advancedlookupenabled = default(bool?), bool? productrecommendationsenabled = default(bool?), int? recurrencedefaultnumberofoccurrences = default(int?), bool? grantaccesstonetworkservice = default(bool?), int? tokenexpiry = default(int?), int? organizationstate = default(int?), int? currencydisplayoption = default(int?), int? maxallowedpendingrollupjobcount = default(int?), bool? sessiontimeoutenabled = default(bool?), string externalbaseurl = default(string), bool? isactionsupportfeatureenabled = default(bool?), string dateseparator = default(string), bool? issalesassistantenabled = default(bool?), string amdesignator = default(string), int? pricingdecimalprecision = default(int?), string kbprefix = default(string), bool? isduplicatedetectionenabled = default(bool?), int? hashmaxcount = default(int?), string reportinggroupname = default(string), bool? isdelegateaccessenabled = default(bool?), string aciwebendpointurl = default(string), string featureset = default(string), int? sessiontimeoutreminderinmins = default(int?), int? reportscripterrors = default(int?), string _modifiedonbehalfbyValue = default(string), int? fiscalyearformatsuffix = default(int?), bool? isemailserverprofilecontentfilteringenabled = default(bool?), bool? allowusersseeappdownloadmessage = default(bool?), string defaultcountrycode = default(string), int? yammerpostmethod = default(int?), bool? isactivityanalysisenabled = default(bool?), int? utcconversiontimezonecode = default(int?), bool? iscontentsecuritypolicyenabled = default(bool?), bool? isduplicatedetectionenabledforimport = default(bool?), bool? ismodeldrivenappsinmsteamsenabled = default(bool?), int? negativeformatcode = default(int?), bool? allowclientmessagebarad = default(bool?), string usergroupid = default(string), bool? isduplicatedetectionenabledforofflinesync = default(bool?), int? languagecode = default(int?), bool? appdesignerexperienceenabled = default(bool?), bool? canoptoutnewsearchexperience = default(bool?), bool? ispreviewenabledforactioncard = default(bool?), string microsoftflowenvironment = default(string), bool? ispaienabled = default(bool?), string entityimageUrl = default(string), int? sessiontimeoutinmins = default(int?), int? maxappointmentdurationdays = default(int?), bool? enablelivepersonacarduci = default(bool?), int? timeformatcode = default(int?), int? dayssincerecordlastmodifiedmaxvalue = default(int?), string _acknowledgementtemplateidValue = default(string), int? maxdepthforhierarchicalsecuritymodel = default(int?), bool? useskypeprotocol = default(bool?), bool? isfolderbasedtrackingenabled = default(bool?), bool? isdefaultcountrycodecheckenabled = default(bool?), int? auditretentionperiod = default(int?), bool? generatealertsforerrors = default(bool?), long? entityimageTimestamp = default(long?), string privreportinggroupname = default(string), bool? uselegacyrendering = default(bool?), int? maximumtrackingnumber = default(int?), bool? allowautoresponsecreation = default(bool?), bool? allowlegacyclientexperience = default(bool?), bool? ismsteamsenabled = default(bool?), bool? enablemicrosoftflowintegration = default(bool?), string yammernetworkpermalink = default(string), bool? allowlegacydialogsembedding = default(bool?), bool? enablepricingoncreate = default(bool?), string initialversion = default(string), int? maximumactivebusinessprocessflowsallowedperentity = default(int?), int? recurrenceexpansionsynchcreatemax = default(int?), int? fiscalperiodtype = default(int?), int? inactivitytimeoutreminderinmins = default(int?), bool? enablelivepersoncardintegrationinoffice = default(bool?), int? maxrecordsforexporttoexcel = default(int?), int? useraccessauditinginterval = default(int?), string _createdonbehalfbyValue = default(string), string kaprefix = default(string), bool? allowmarketingemailexecution = default(bool?), string officegraphdelveurl = default(string), string timeformatstring = default(string), bool? iscontextualemailenabled = default(bool?), int? dateformatcode = default(int?), int? fullnameconventioncode = default(int?), bool? syncoptinselection = default(bool?), int? sortid = default(int?), string disabledreason = default(string), bool? isallmoneydecimal = default(bool?), bool? isauditenabled = default(bool?), string fiscalyearformat = default(string), bool? ignoreinternalemail = default(bool?), string _basecurrencyidValue = default(string), int? rierrorstatus = default(int?), string defaultcrmcustomname = default(string), bool? emailcorrelationenabled = default(bool?), int? hashdeltasubjectcount = default(int?), int? currencyformatcode = default(int?), bool? yammeroauthaccesstokenexpired = default(bool?), bool? isbpfentitycustomizationfeatureenabled = default(bool?), string privacystatementurl = default(string), string businessclosurecalendarid = default(string), bool? showweeknumber = default(bool?), int? uniquespecifierlength = default(int?), bool? sendbulkemailinuci = default(bool?), bool? improvesearchloggingenabled = default(bool?), string _defaultemailserverprofileidValue = default(string), string telemetryinstrumentationkey = default(string), bool? isappointmentattachmentsyncenabled = default(bool?), bool? isnewaddproductexperienceenabled = default(bool?), int? maxverboseloggingmailbox = default(int?), string slapausestates = default(string), bool? quickfindrecordlimitenabled = default(bool?), string sampledataimportid = default(string), string name = default(string), int? currencydecimalprecision = default(int?), int? emailconnectionchannel = default(int?), bool? ispreviewforemailmonitoringallowed = default(bool?), int? maxallowedpendingrollupjobpercentage = default(int?), bool? allowunresolvedpartiesonemailsend = default(bool?), bool? isautodatacapturev2enabled = default(bool?), int? fiscalperiodformatperiod = default(int?), string externalpartyentitysettings = default(string), bool? globalappendurlparametersenabled = default(bool?), int? inactivitytimeoutinmins = default(int?), bool? sqmenabled = default(bool?), string parsedtablecolumnprefix = default(string), bool? socialinsightsenabled = default(bool?), string decimalsymbol = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string signupoutlookdownloadfwlink = default(string), bool? disablesocialcare = default(bool?), bool? resolvesimilarunresolvedemailaddress = default(bool?), int? maxproductsinbundle = default(int?), bool? sharetopreviousowneronassign = default(bool?), bool? isactioncardenabled = default(bool?), string fiscalperiodformat = default(string), string reportinggroupid = default(string), string qualifyleadadditionaloptions = default(string), bool? isfolderautocreatedonsp = default(bool?), int? maxfolderbasedtrackingmappings = default(int?), string sqlaccessgroupid = default(string), string trackingprefix = default(string), int? yammergroupid = default(int?), string dateformatstring = default(string), string defaultthemedata = default(string), bool? allowuserformmodepreference = default(bool?), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> lkPrincipalobjectattributeaccessOrganizationid = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), IList<MicrosoftDynamicsCRMtheme> organizationTheme = default(IList<MicrosoftDynamicsCRMtheme>), IList<MicrosoftDynamicsCRMusermapping> organizationUserMapping = default(IList<MicrosoftDynamicsCRMusermapping>), IList<MicrosoftDynamicsCRMmetric> organizationMetric = default(IList<MicrosoftDynamicsCRMmetric>), IList<MicrosoftDynamicsCRMposition> organizationPosition = default(IList<MicrosoftDynamicsCRMposition>), IList<MicrosoftDynamicsCRMofficegraphdocument> organizationOfficegraphdocument = default(IList<MicrosoftDynamicsCRMofficegraphdocument>), IList<MicrosoftDynamicsCRMrecommendeddocument> organizationRecommendeddocument = default(IList<MicrosoftDynamicsCRMrecommendeddocument>), IList<MicrosoftDynamicsCRMknowledgebaserecord> organizationKnowledgeBaseRecord = default(IList<MicrosoftDynamicsCRMknowledgebaserecord>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMsdkmessagefilter> organizationSdkmessagefilter = default(IList<MicrosoftDynamicsCRMsdkmessagefilter>), IList<MicrosoftDynamicsCRMwebresource> webresourceOrganization = default(IList<MicrosoftDynamicsCRMwebresource>), IList<MicrosoftDynamicsCRMpost> organizationPost = default(IList<MicrosoftDynamicsCRMpost>), IList<MicrosoftDynamicsCRMpostcomment> organizationPostComment = default(IList<MicrosoftDynamicsCRMpostcomment>), IList<MicrosoftDynamicsCRMpostlike> organizationPostlike = default(IList<MicrosoftDynamicsCRMpostlike>), IList<MicrosoftDynamicsCRMimportjob> organizationImportjob = default(IList<MicrosoftDynamicsCRMimportjob>), IList<MicrosoftDynamicsCRMqueue> organizationQueues = default(IList<MicrosoftDynamicsCRMqueue>), MicrosoftDynamicsCRMcalendar businessclosurecalendaridCalendar = default(MicrosoftDynamicsCRMcalendar), IList<MicrosoftDynamicsCRMpluginassembly> organizationPluginassembly = default(IList<MicrosoftDynamicsCRMpluginassembly>), IList<MicrosoftDynamicsCRMfieldsecurityprofile> lkFieldsecurityprofileOrganizationid = default(IList<MicrosoftDynamicsCRMfieldsecurityprofile>), IList<MicrosoftDynamicsCRMsimilarityrule> organizationSimilarityrule = default(IList<MicrosoftDynamicsCRMsimilarityrule>), IList<MicrosoftDynamicsCRMexpiredprocess> organizationExpiredprocess = default(IList<MicrosoftDynamicsCRMexpiredprocess>), IList<MicrosoftDynamicsCRMappconfiginstance> organizationAppconfiginstance = default(IList<MicrosoftDynamicsCRMappconfiginstance>), IList<MicrosoftDynamicsCRMsavedqueryvisualization> organizationSavedQueryVisualizations = default(IList<MicrosoftDynamicsCRMsavedqueryvisualization>), IList<MicrosoftDynamicsCRMsystemuser> organizationSystemUsers = default(IList<MicrosoftDynamicsCRMsystemuser>), IList<MicrosoftDynamicsCRMpublisher> organizationPublisher = default(IList<MicrosoftDynamicsCRMpublisher>), IList<MicrosoftDynamicsCRMplugintype> organizationPlugintype = default(IList<MicrosoftDynamicsCRMplugintype>), IList<MicrosoftDynamicsCRMsyncerror> organizationSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), IList<MicrosoftDynamicsCRMdataperformance> lkDataperformanceOrganizationid = default(IList<MicrosoftDynamicsCRMdataperformance>), IList<MicrosoftDynamicsCRMserviceendpoint> organizationServiceendpoint = default(IList<MicrosoftDynamicsCRMserviceendpoint>), IList<MicrosoftDynamicsCRMdisplaystring> organizationCustomDisplaystrings = default(IList<MicrosoftDynamicsCRMdisplaystring>), IList<MicrosoftDynamicsCRMsdkmessageprocessingstep> organizationSdkmessageprocessingstep = default(IList<MicrosoftDynamicsCRMsdkmessageprocessingstep>), IList<MicrosoftDynamicsCRMplugintypestatistic> organizationPlugintypestatistic = default(IList<MicrosoftDynamicsCRMplugintypestatistic>), MicrosoftDynamicsCRMtransactioncurrency basecurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency), IList<MicrosoftDynamicsCRMasyncoperation> organizationAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMemailserverprofile> organizationEmailserverprofile = default(IList<MicrosoftDynamicsCRMemailserverprofile>), IList<MicrosoftDynamicsCRMsavedquery> organizationSavedQueries = default(IList<MicrosoftDynamicsCRMsavedquery>), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMsitemap> organizationSitemap = default(IList<MicrosoftDynamicsCRMsitemap>), IList<MicrosoftDynamicsCRMteam> organizationTeams = default(IList<MicrosoftDynamicsCRMteam>), MicrosoftDynamicsCRMmobileofflineprofile defaultmobileofflineprofileid = default(MicrosoftDynamicsCRMmobileofflineprofile), IList<MicrosoftDynamicsCRMdocumenttemplate> lkDocumenttemplatebaseOrganization = default(IList<MicrosoftDynamicsCRMdocumenttemplate>), IList<MicrosoftDynamicsCRMqueueitem> organizationQueueitems = default(IList<MicrosoftDynamicsCRMqueueitem>), IList<MicrosoftDynamicsCRMcomplexcontrol> organizationComplexcontrols = default(IList<MicrosoftDynamicsCRMcomplexcontrol>), IList<MicrosoftDynamicsCRMsolution> organizationSolution = default(IList<MicrosoftDynamicsCRMsolution>), IList<MicrosoftDynamicsCRMbusinessunit> organizationBusinessUnits = default(IList<MicrosoftDynamicsCRMbusinessunit>), IList<MicrosoftDynamicsCRMmobileofflineprofile> mobileOfflineProfileOrganization = default(IList<MicrosoftDynamicsCRMmobileofflineprofile>), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMsdkmessageprocessingstepimage> organizationSdkmessageprocessingstepimage = default(IList<MicrosoftDynamicsCRMsdkmessageprocessingstepimage>), IList<MicrosoftDynamicsCRMcustomcontrol> customcontrolOrganization = default(IList<MicrosoftDynamicsCRMcustomcontrol>), IList<MicrosoftDynamicsCRMsdkmessageprocessingstepsecureconfig> organizationSdkmessageprocessingstepsecureconfig = default(IList<MicrosoftDynamicsCRMsdkmessageprocessingstepsecureconfig>), IList<MicrosoftDynamicsCRMrole> organizationRoles = default(IList<MicrosoftDynamicsCRMrole>), IList<MicrosoftDynamicsCRMappconfigmaster> organizationAppconfigmaster = default(IList<MicrosoftDynamicsCRMappconfigmaster>), IList<MicrosoftDynamicsCRMmobileofflineprofileitemassociation> mobileOfflineProfileItemAssociationOrganization = default(IList<MicrosoftDynamicsCRMmobileofflineprofileitemassociation>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> organizationMailboxTrackingFolder = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMbulkdeletefailure> organizationBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMtranslationprocess> organizationTranslationprocess = default(IList<MicrosoftDynamicsCRMtranslationprocess>), IList<MicrosoftDynamicsCRMtracelog> organizationTracelog = default(IList<MicrosoftDynamicsCRMtracelog>), IList<MicrosoftDynamicsCRMsystemform> organizationSystemforms = default(IList<MicrosoftDynamicsCRMsystemform>), IList<MicrosoftDynamicsCRMbusinessunitnewsarticle> organizationBusinessUnitNewsArticles = default(IList<MicrosoftDynamicsCRMbusinessunitnewsarticle>), IList<MicrosoftDynamicsCRMkbarticle> organizationKbArticles = default(IList<MicrosoftDynamicsCRMkbarticle>), IList<MicrosoftDynamicsCRMsdkmessage> organizationSdkmessage = default(IList<MicrosoftDynamicsCRMsdkmessage>), IList<MicrosoftDynamicsCRMmobileofflineprofileitem> mobileOfflineProfileItemOrganization = default(IList<MicrosoftDynamicsCRMmobileofflineprofileitem>), MicrosoftDynamicsCRMemailserverprofile defaultemailserverprofileid = default(MicrosoftDynamicsCRMemailserverprofile), IList<MicrosoftDynamicsCRMkbarticletemplate> organizationKbArticleTemplates = default(IList<MicrosoftDynamicsCRMkbarticletemplate>), IList<MicrosoftDynamicsCRMcustomcontrolresource> customcontrolresourceOrganization = default(IList<MicrosoftDynamicsCRMcustomcontrolresource>), IList<MicrosoftDynamicsCRMmailbox> organizationMailbox = default(IList<MicrosoftDynamicsCRMmailbox>), IList<MicrosoftDynamicsCRMcalendar> organizationCalendars = default(IList<MicrosoftDynamicsCRMcalendar>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMwebwizard> organizationWebwizard = default(IList<MicrosoftDynamicsCRMwebwizard>), IList<MicrosoftDynamicsCRMconnectionrole> organizationConnectionRoles = default(IList<MicrosoftDynamicsCRMconnectionrole>), IList<MicrosoftDynamicsCRMcustomcontroldefaultconfig> customcontroldefaultconfigOrganization = default(IList<MicrosoftDynamicsCRMcustomcontroldefaultconfig>), IList<MicrosoftDynamicsCRMtransactioncurrency> organizationTransactioncurrencies = default(IList<MicrosoftDynamicsCRMtransactioncurrency>), MicrosoftDynamicsCRMtemplate acknowledgementtemplateid = default(MicrosoftDynamicsCRMtemplate), IList<MicrosoftDynamicsCRMnewprocess> organizationNewprocess = default(IList<MicrosoftDynamicsCRMnewprocess>), IList<MicrosoftDynamicsCRMaciviewmapper> organizationAciviewmapper = default(IList<MicrosoftDynamicsCRMaciviewmapper>), IList<MicrosoftDynamicsCRMlanguagelocale> languagelocaleOrganization = default(IList<MicrosoftDynamicsCRMlanguagelocale>), IList<MicrosoftDynamicsCRMappconfig> organizationAppconfig = default(IList<MicrosoftDynamicsCRMappconfig>), IList<MicrosoftDynamicsCRMappmodule> organizationAppmodule = default(IList<MicrosoftDynamicsCRMappmodule>), IList<MicrosoftDynamicsCRMnavigationsetting> organizationNavigationsetting = default(IList<MicrosoftDynamicsCRMnavigationsetting>), IList<MicrosoftDynamicsCRMsubject> organizationSubjects = default(IList<MicrosoftDynamicsCRMsubject>), IList<MicrosoftDynamicsCRMsolutioncomponentattributeconfiguration> organizationSolutioncomponentattributeconfiguration = default(IList<MicrosoftDynamicsCRMsolutioncomponentattributeconfiguration>), IList<MicrosoftDynamicsCRMsolutioncomponentconfiguration> organizationSolutioncomponentconfiguration = default(IList<MicrosoftDynamicsCRMsolutioncomponentconfiguration>), IList<MicrosoftDynamicsCRMsolutioncomponentrelationshipconfiguration> organizationSolutioncomponentrelationshipconfiguration = default(IList<MicrosoftDynamicsCRMsolutioncomponentrelationshipconfiguration>), IList<MicrosoftDynamicsCRMpackage> organizationPackage = default(IList<MicrosoftDynamicsCRMpackage>), IList<MicrosoftDynamicsCRMrelationshipattribute> organizationRelationshipattribute = default(IList<MicrosoftDynamicsCRMrelationshipattribute>), IList<MicrosoftDynamicsCRMentityanalyticsconfig> organizationEntityanalyticsconfig = default(IList<MicrosoftDynamicsCRMentityanalyticsconfig>), IList<MicrosoftDynamicsCRMdatalakeworkspace> organizationDatalakeworkspace = default(IList<MicrosoftDynamicsCRMdatalakeworkspace>), IList<MicrosoftDynamicsCRMdatalakeworkspacepermission> organizationDatalakeworkspacepermission = default(IList<MicrosoftDynamicsCRMdatalakeworkspacepermission>), IList<MicrosoftDynamicsCRMmsdynHelppage> organizationMsdynHelppage = default(IList<MicrosoftDynamicsCRMmsdynHelppage>), IList<MicrosoftDynamicsCRMterritory> organizationTerritories = default(IList<MicrosoftDynamicsCRMterritory>), IList<MicrosoftDynamicsCRMmsdynFederatedarticleincident> organizationMsdynFederatedarticleincident = default(IList<MicrosoftDynamicsCRMmsdynFederatedarticleincident>), IList<MicrosoftDynamicsCRMcatalog> organizationCatalog = default(IList<MicrosoftDynamicsCRMcatalog>), IList<MicrosoftDynamicsCRMcatalogassignment> organizationCatalogassignment = default(IList<MicrosoftDynamicsCRMcatalogassignment>), IList<MicrosoftDynamicsCRMteammobileofflineprofilemembership> organizationTeammobileofflineprofilemembership = default(IList<MicrosoftDynamicsCRMteammobileofflineprofilemembership>), IList<MicrosoftDynamicsCRMusermobileofflineprofilemembership> organizationUsermobileofflineprofilemembership = default(IList<MicrosoftDynamicsCRMusermobileofflineprofilemembership>), IList<MicrosoftDynamicsCRMorganizationdatasyncsubscription> organizationOrganizationdatasyncsubscription = default(IList<MicrosoftDynamicsCRMorganizationdatasyncsubscription>), IList<MicrosoftDynamicsCRMorganizationdatasyncsubscriptionentity> organizationOrganizationdatasyncsubscriptionentity = default(IList<MicrosoftDynamicsCRMorganizationdatasyncsubscriptionentity>), IList<MicrosoftDynamicsCRMmsdynSolutionhealthruleset> organizationMsdynSolutionhealthruleset = default(IList<MicrosoftDynamicsCRMmsdynSolutionhealthruleset>), IList<MicrosoftDynamicsCRMmsdynKmpersonalizationsetting> organizationMsdynKmpersonalizationsetting = default(IList<MicrosoftDynamicsCRMmsdynKmpersonalizationsetting>), IList<MicrosoftDynamicsCRMvirtualentitymetadata> organizationVirtualentitymetadata = default(IList<MicrosoftDynamicsCRMvirtualentitymetadata>), IList<MicrosoftDynamicsCRMmsdynTour> organizationMsdynTour = default(IList<MicrosoftDynamicsCRMmsdynTour>), IList<MicrosoftDynamicsCRMpluginpackage> organizationPluginpackage = default(IList<MicrosoftDynamicsCRMpluginpackage>), IList<MicrosoftDynamicsCRMappaction> organizationAppaction = default(IList<MicrosoftDynamicsCRMappaction>))
        {
            ...
            Newsearchexperienceenabled = newsearchexperienceenabled;
            ...
            Relevancesearchmodifiedon = relevancesearchmodifiedon;
            ...
            Lookupresolvedelayms = lookupresolvedelayms;
            ...
            Lookupcharactercountbeforeresolve = lookupcharactercountbeforeresolve;
            ...
            Relevancesearchenabledbyplatform = relevancesearchenabledbyplatform;
            ...
            Advancedlookupenabled = advancedlookupenabled;
            ...
            Maxallowedpendingrollupjobcount = maxallowedpendingrollupjobcount;
            ...
            Canoptoutnewsearchexperience = canoptoutnewsearchexperience;
            ...
            Improvesearchloggingenabled = improvesearchloggingenabled;
            ...
            Maxallowedpendingrollupjobpercentage = maxallowedpendingrollupjobpercentage;
            ...
            OrganizationRelationshipattribute = organizationRelationshipattribute;
            ...
            OrganizationTeammobileofflineprofilemembership = organizationTeammobileofflineprofilemembership;
            OrganizationUsermobileofflineprofilemembership = organizationUsermobileofflineprofilemembership;
            OrganizationOrganizationdatasyncsubscription = organizationOrganizationdatasyncsubscription;
            OrganizationOrganizationdatasyncsubscriptionentity = organizationOrganizationdatasyncsubscriptionentity;
            OrganizationMsdynSolutionhealthruleset = organizationMsdynSolutionhealthruleset;
            OrganizationMsdynKmpersonalizationsetting = organizationMsdynKmpersonalizationsetting;
            OrganizationVirtualentitymetadata = organizationVirtualentitymetadata;
            OrganizationMsdynTour = organizationMsdynTour;
            OrganizationPluginpackage = organizationPluginpackage;
            OrganizationAppaction = organizationAppaction;
            CustomInit();
        }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "releasewavename")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "newsearchexperienceenabled")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "relevancesearchmodifiedon")]
        public System.DateTimeOffset? Relevancesearchmodifiedon { get; set; }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "lookupresolvedelayms")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "lookupcharactercountbeforeresolve")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "relevancesearchenabledbyplatform")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "advancedlookupenabled")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "maxallowedpendingrollupjobcount")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "canoptoutnewsearchexperience")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "improvesearchloggingenabled")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "telemetryinstrumentationkey")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "maxallowedpendingrollupjobpercentage")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_relationshipattribute")]
        public IList<MicrosoftDynamicsCRMrelationshipattribute> OrganizationRelationshipattribute { get; set; }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_teammobileofflineprofilemembership")]
        public IList<MicrosoftDynamicsCRMteammobileofflineprofilemembership> OrganizationTeammobileofflineprofilemembership { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_usermobileofflineprofilemembership")]
        public IList<MicrosoftDynamicsCRMusermobileofflineprofilemembership> OrganizationUsermobileofflineprofilemembership { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_organizationdatasyncsubscription")]
        public IList<MicrosoftDynamicsCRMorganizationdatasyncsubscription> OrganizationOrganizationdatasyncsubscription { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_organizationdatasyncsubscriptionentity")]
        public IList<MicrosoftDynamicsCRMorganizationdatasyncsubscriptionentity> OrganizationOrganizationdatasyncsubscriptionentity { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_msdyn_solutionhealthruleset")]
        public IList<MicrosoftDynamicsCRMmsdynSolutionhealthruleset> OrganizationMsdynSolutionhealthruleset { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_msdyn_kmpersonalizationsetting")]
        public IList<MicrosoftDynamicsCRMmsdynKmpersonalizationsetting> OrganizationMsdynKmpersonalizationsetting { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_virtualentitymetadata")]
        public IList<MicrosoftDynamicsCRMvirtualentitymetadata> OrganizationVirtualentitymetadata { get; set; }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_pluginpackage")]
        public IList<MicrosoftDynamicsCRMpluginpackage> OrganizationPluginpackage { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "organization_appaction")]
        public IList<MicrosoftDynamicsCRMappaction> OrganizationAppaction { get; set; }
