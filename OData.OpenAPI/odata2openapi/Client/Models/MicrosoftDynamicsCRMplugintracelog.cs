...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMplugintracelog
    {
        ...
        /// MicrosoftDynamicsCRMplugintracelog class.
        /// </summary>
        public MicrosoftDynamicsCRMplugintracelog(string secureconfiguration = default(string), string organizationid = default(string), string pluginstepid = default(string), string persistencekey = default(string), string _createdbyValue = default(string), System.DateTimeOffset? performanceexecutionstarttime = default(System.DateTimeOffset?), int? performanceexecutionduration = default(int?), bool? issystemcreated = default(bool?), string requestid = default(string), string plugintracelogid = default(string), System.DateTimeOffset? performanceconstructorstarttime = default(System.DateTimeOffset?), string correlationid = default(string), string _createdonbehalfbyValue = default(string), int? operationtype = default(int?), int? depth = default(int?), int? performanceconstructorduration = default(int?), string configuration = default(string), int? mode = default(int?), string messagename = default(string), string profile = default(string), string primaryentity = default(string), string typename = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string exceptiondetails = default(string), string messageblock = default(string), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser))
        {
