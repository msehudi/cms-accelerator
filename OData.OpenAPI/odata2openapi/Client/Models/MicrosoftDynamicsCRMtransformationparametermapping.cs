...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMtransformationparametermapping
    {
        ...
        /// MicrosoftDynamicsCRMtransformationparametermapping class.
        /// </summary>
        public MicrosoftDynamicsCRMtransformationparametermapping(string transformationparametermappingid = default(string), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), int? parametersequence = default(int?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), int? parameterarrayindex = default(int?), string _modifiedbyValue = default(string), bool? ismanaged = default(bool?), string _transformationmappingidValue = default(string), string data = default(string), int? datatypecode = default(int?), string transformationparametermappingidunique = default(string), string _createdonbehalfbyValue = default(string), string _modifiedonbehalfbyValue = default(string), string _createdbyValue = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), int? componentstate = default(int?), int? parametertypecode = default(int?), string introducedversion = default(string), string solutionid = default(string), MicrosoftDynamicsCRMtransformationmapping transformationmappingid = default(MicrosoftDynamicsCRMtransformationmapping), IList<MicrosoftDynamicsCRMlookupmapping> lookUpMappingTransformationParameterMapping = default(IList<MicrosoftDynamicsCRMlookupmapping>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser))
        {
