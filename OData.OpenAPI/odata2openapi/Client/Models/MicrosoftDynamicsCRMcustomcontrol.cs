...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcustomcontrol
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMcustomcontrol(bool? ismanaged = default(bool?), string _organizationidValue = default(string), string _createdonbehalfbyValue = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string _modifiedonbehalfbyValue = default(string), string solutionid = default(string), string compatibledatatypes = default(string), string clientjson = default(string), string introducedversion = default(string), string customcontrolid = default(string), string authoringmanifest = default(string), string _createdbyValue = default(string), string customcontrolidunique = default(string), int? componentstate = default(int?), string name = default(string), string version = default(string), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), string manifest = default(string), string versionnumber = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string _modifiedbyValue = default(string), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMcustomcontrolresource> customcontrolResourceId = default(IList<MicrosoftDynamicsCRMcustomcontrolresource>), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser))
        {
            Ismanaged = ismanaged;
