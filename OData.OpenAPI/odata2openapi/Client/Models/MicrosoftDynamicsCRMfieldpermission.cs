...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMfieldpermission
    {
        ...
        /// MicrosoftDynamicsCRMfieldpermission class.
        /// </summary>
        public MicrosoftDynamicsCRMfieldpermission(bool? ismanaged = default(bool?), string fieldpermissionid = default(string), int? canupdate = default(int?), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), string solutionid = default(string), int? componentstate = default(int?), int? canread = default(int?), string _organizationidValue = default(string), int? cancreate = default(int?), string _fieldsecurityprofileidValue = default(string), string versionnumber = default(string), string fieldpermissionidunique = default(string), string attributelogicalname = default(string), string entityname = default(string), IList<MicrosoftDynamicsCRMsyncerror> fieldPermissionSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), MicrosoftDynamicsCRMfieldsecurityprofile fieldsecurityprofileid = default(MicrosoftDynamicsCRMfieldsecurityprofile), MicrosoftDynamicsCRMsolution solutionFieldpermission = default(MicrosoftDynamicsCRMsolution))
        {
            Ismanaged = ismanaged;
