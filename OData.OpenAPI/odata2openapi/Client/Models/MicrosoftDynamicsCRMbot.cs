...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMbot
    {
        ...
        /// Initializes a new instance of the MicrosoftDynamicsCRMbot class.
        /// </summary>
        public MicrosoftDynamicsCRMbot(int? utcconversiontimezonecode = default(int?), bool? ismanaged = default(bool?), int? timezoneruleversionnumber = default(int?), string solutionid = default(string), int? componentstate = default(int?), string _createdonbehalfbyValue = default(string), string componentidunique = default(string), string _modifiedbyValue = default(string), int? importsequencenumber = default(int?), string botid = default(string), int? accesscontrolpolicy = default(int?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string _owningbusinessunitValue = default(string), string configuration = default(string), string _owninguserValue = default(string), int? statecode = default(int?), string _createdbyValue = default(string), string authorizedsecuritygroupids = default(string), int? language = default(int?), string name = default(string), string iscustomizable = default(string), System.DateTimeOffset? publishedon = default(System.DateTimeOffset?), string schemaname = default(string), int? authenticationmode = default(int?), string _owningteamValue = default(string), int? statuscode = default(int?), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), string applicationmanifestinformation = default(string), string _modifiedonbehalfbyValue = default(string), string _publishedbyValue = default(string), int? authenticationtrigger = default(int?), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), string versionnumber = default(string), string iconbase64 = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string _owneridValue = default(string), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser owninguser = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMteam owningteam = default(MicrosoftDynamicsCRMteam), MicrosoftDynamicsCRMprincipal ownerid = default(MicrosoftDynamicsCRMprincipal), MicrosoftDynamicsCRMbusinessunit owningbusinessunit = default(MicrosoftDynamicsCRMbusinessunit), IList<MicrosoftDynamicsCRMsyncerror> botSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), IList<MicrosoftDynamicsCRMasyncoperation> botAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> botMailboxTrackingFolders = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMprocesssession> botProcessSession = default(IList<MicrosoftDynamicsCRMprocesssession>), IList<MicrosoftDynamicsCRMbulkdeletefailure> botBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> botPrincipalObjectAttributeAccesses = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), IList<MicrosoftDynamicsCRMbotcomponent> botBotcomponent = default(IList<MicrosoftDynamicsCRMbotcomponent>), IList<MicrosoftDynamicsCRMconversationtranscript> botConversationtranscript = default(IList<MicrosoftDynamicsCRMconversationtranscript>), IList<MicrosoftDynamicsCRMenvironmentvariabledefinition> botEnvironmentvariabledefinition = default(IList<MicrosoftDynamicsCRMenvironmentvariabledefinition>), MicrosoftDynamicsCRMsystemuser publishedby = default(MicrosoftDynamicsCRMsystemuser))
        {
        ...
        public IList<MicrosoftDynamicsCRMenvironmentvariabledefinition> BotEnvironmentvariabledefinition { get; set; }
