...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcontact
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMcontact(string spousesname = default(string), string emailaddress3 = default(string), string address3Telephone3 = default(string), long? entityimageTimestamp = default(long?), string contactid = default(string), string mobilephone = default(string), int? utcconversiontimezonecode = default(int?), int? address3Shippingmethodcode = default(int?), string address3Postalcode = default(string), decimal? annualincome = default(decimal?), string fax = default(string), string telephone3 = default(string), string address1Primarycontactname = default(string), string address3City = default(string), System.DateTimeOffset? lastonholdtime = default(System.DateTimeOffset?), string address2Stateorprovince = default(string), string _createdbyValue = default(string), string address2Line1 = default(string), string assistantphone = default(string), System.DateTimeOffset? lastusedincampaign = default(System.DateTimeOffset?), int? address3Freighttermscode = default(int?), string pager = default(string), string employeeid = default(string), int? territorycode = default(int?), string _parentcustomeridValue = default(string), string managername = default(string), System.DateTimeOffset? birthdate = default(System.DateTimeOffset?), string address1Name = default(string), string department = default(string), string address3Country = default(string), string address2Telephone1 = default(string), string address2Primarycontactname = default(string), decimal? address2Latitude = default(decimal?), int? timezoneruleversionnumber = default(int?), string address1Stateorprovince = default(string), string versionnumber = default(string), string address2Postalcode = default(string), string _owninguserValue = default(string), string rraPassword = default(string), string _masteridValue = default(string), string _createdonbehalfbyValue = default(string), string address3Postofficebox = default(string), string subscriptionid = default(string), string business2 = default(string), string address3County = default(string), decimal? address1Latitude = default(decimal?), int? address1Freighttermscode = default(int?), int? customertypecode = default(int?), int? address3Addresstypecode = default(int?), decimal? address1Longitude = default(decimal?), int? address1Addresstypecode = default(int?), int? statuscode = default(int?), string yomifullname = default(string), decimal? aging90Base = default(decimal?), string _accountidValue = default(string), string address3Primarycontactname = default(string), int? familystatuscode = default(int?), string home2 = default(string), string address3Addressid = default(string), decimal? aging60 = default(decimal?), int? statecode = default(int?), int? address2Freighttermscode = default(int?), string address1Composite = default(string), string telephone2 = default(string), string yomimiddlename = default(string), string _modifiedonbehalfbyValue = default(string), string jobtitle = default(string), int? address2Addresstypecode = default(int?), int? educationcode = default(int?), string address1Telephone3 = default(string), int? address2Shippingmethodcode = default(int?), bool? followemail = default(bool?), int? preferredcontactmethodcode = default(int?), int? importsequencenumber = default(int?), int? gendercode = default(int?), string address2Line2 = default(string), decimal? annualincomeBase = default(decimal?), decimal? aging60Base = default(decimal?), string address3Line1 = default(string), string address1County = default(string), string _owningbusinessunitValue = default(string), string _createdbyexternalpartyValue = default(string), string entityimageid = default(string), string processid = default(string), string address1Telephone2 = default(string), string description = default(string), string address1Fax = default(string), bool? marketingonly = default(bool?), string address3Line2 = default(string), string address1Addressid = default(string), string _slaidValue = default(string), bool? donotpostalmail = default(bool?), int? address2Utcoffset = default(int?), string websiteurl = default(string), decimal? exchangerate = default(decimal?), decimal? aging30Base = default(decimal?), string callback = default(string), string emailaddress2 = default(string), string address2Line3 = default(string), string managerphone = default(string), int? preferredappointmentdaycode = default(int?), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), string firstname = default(string), string address1Telephone1 = default(string), string address3Composite = default(string), string address3Fax = default(string), string childrensnames = default(string), string _owningteamValue = default(string), int? numberofchildren = default(int?), string address2Postofficebox = default(string), decimal? aging90 = default(decimal?), bool? donotbulkpostalmail = default(bool?), string emailaddress1 = default(string), bool? donotbulkemail = default(bool?), int? customersizecode = default(int?), string address1City = default(string), int? preferredappointmenttimecode = default(int?), decimal? address3Latitude = default(decimal?), string _transactioncurrencyidValue = default(string), byte[] entityimage = default(byte[]), string _modifiedbyexternalpartyValue = default(string), int? paymenttermscode = default(int?), string address3Name = default(string), string fullname = default(string), int? leadsourcecode = default(int?), bool? merged = default(bool?), string ftpsiteurl = default(string), int? address1Shippingmethodcode = default(int?), string _modifiedbyValue = default(string), string _preferredsystemuseridValue = default(string), string address2Telephone2 = default(string), string _slainvokedidValue = default(string), int? address3Utcoffset = default(int?), string address3Stateorprovince = default(string), string address3Telephone1 = default(string), string nickname = default(string), string address1Postofficebox = default(string), string assistantname = default(string), string address2Country = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string externaluseridentifier = default(string), string address2Name = default(string), string stageid = default(string), bool? creditonhold = default(bool?), decimal? address3Longitude = default(decimal?), int? onholdtime = default(int?), string address2Telephone3 = default(string), bool? donotfax = default(bool?), bool? donotphone = default(bool?), string address3Upszone = default(string), int? accountrolecode = default(int?), decimal? aging30 = default(decimal?), string address2Upszone = default(string), string address1Upszone = default(string), decimal? creditlimit = default(decimal?), string salutation = default(string), string suffix = default(string), string traversedpath = default(string), int? address1Utcoffset = default(int?), string yomilastname = default(string), string governmentid = default(string), bool? donotsendmm = default(bool?), decimal? address2Longitude = default(decimal?), string address1Country = default(string), string lastname = default(string), string address2City = default(string), bool? donotemail = default(bool?), string company = default(string), string address1Line2 = default(string), string address3Telephone2 = default(string), string yomifirstname = default(string), string telephone1 = default(string), string address1Line1 = default(string), string address2Addressid = default(string), bool? isbackofficecustomer = default(bool?), string address2Composite = default(string), string address2County = default(string), int? shippingmethodcode = default(int?), decimal? creditlimitBase = default(decimal?), System.DateTimeOffset? anniversary = default(System.DateTimeOffset?), string _owneridValue = default(string), string _parentcontactidValue = default(string), int? haschildrencode = default(int?), string address2Fax = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string entityimageUrl = default(string), string address1Line3 = default(string), string middlename = default(string), string address1Postalcode = default(string), string address3Line3 = default(string), string timespentbymeonemailandmeetings = default(string), bool? participatesinworkflow = default(bool?), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> contactPrincipalobjectattributeaccess = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), IList<MicrosoftDynamicsCRMconnection> contactConnections1 = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMfeedback> contactFeedback = default(IList<MicrosoftDynamicsCRMfeedback>), IList<MicrosoftDynamicsCRMprocesssession> contactProcessSessions = default(IList<MicrosoftDynamicsCRMprocesssession>), MicrosoftDynamicsCRMprocessstage stageidProcessstage = default(MicrosoftDynamicsCRMprocessstage), IList<MicrosoftDynamicsCRMactivitypointer> contactActivityPointers = default(IList<MicrosoftDynamicsCRMactivitypointer>), IList<MicrosoftDynamicsCRMsocialactivity> contactSocialActivities = default(IList<MicrosoftDynamicsCRMsocialactivity>), IList<MicrosoftDynamicsCRMfeedback> lkContactFeedbackCreatedonbehalfby = default(IList<MicrosoftDynamicsCRMfeedback>), IList<MicrosoftDynamicsCRMpostfollow> contactPostFollows = default(IList<MicrosoftDynamicsCRMpostfollow>), IList<MicrosoftDynamicsCRMpostregarding> contactPostRegardings = default(IList<MicrosoftDynamicsCRMpostregarding>), IList<MicrosoftDynamicsCRMsocialactivity> socialactivityPostauthorContacts = default(IList<MicrosoftDynamicsCRMsocialactivity>), IList<MicrosoftDynamicsCRMphonecall> contactPhonecalls = default(IList<MicrosoftDynamicsCRMphonecall>), IList<MicrosoftDynamicsCRMtask> contactTasks = default(IList<MicrosoftDynamicsCRMtask>), IList<MicrosoftDynamicsCRMsyncerror> contactSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), MicrosoftDynamicsCRMsla slainvokedidContactSla = default(MicrosoftDynamicsCRMsla), MicrosoftDynamicsCRMsla slaContactSla = default(MicrosoftDynamicsCRMsla), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMannotation> contactAnnotation = default(IList<MicrosoftDynamicsCRMannotation>), MicrosoftDynamicsCRMcontact masterid = default(MicrosoftDynamicsCRMcontact), IList<MicrosoftDynamicsCRMcontact> contactMasterContact = default(IList<MicrosoftDynamicsCRMcontact>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMemail> contactEmailEmailSender = default(IList<MicrosoftDynamicsCRMemail>), IList<MicrosoftDynamicsCRMaccount> accountPrimaryContact = default(IList<MicrosoftDynamicsCRMaccount>), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMactioncard> contactActioncard = default(IList<MicrosoftDynamicsCRMactioncard>), IList<MicrosoftDynamicsCRMsocialactivity> socialactivityPostauthoraccountContacts = default(IList<MicrosoftDynamicsCRMsocialactivity>), IList<MicrosoftDynamicsCRMsocialprofile> socialprofileCustomerContacts = default(IList<MicrosoftDynamicsCRMsocialprofile>), IList<MicrosoftDynamicsCRMcustomeraddress> contactCustomerAddress = default(IList<MicrosoftDynamicsCRMcustomeraddress>), MicrosoftDynamicsCRMbusinessunit owningbusinessunit = default(MicrosoftDynamicsCRMbusinessunit), MicrosoftDynamicsCRMteam owningteam = default(MicrosoftDynamicsCRMteam), MicrosoftDynamicsCRMaccount parentcustomeridAccount = default(MicrosoftDynamicsCRMaccount), IList<MicrosoftDynamicsCRMduplicaterecord> contactDuplicateMatchingRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), IList<MicrosoftDynamicsCRMfeedback> lkContactFeedbackCreatedby = default(IList<MicrosoftDynamicsCRMfeedback>), IList<MicrosoftDynamicsCRMslakpiinstance> slakpiinstanceContact = default(IList<MicrosoftDynamicsCRMslakpiinstance>), MicrosoftDynamicsCRMsystemuser preferredsystemuserid = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMfax> contactFaxes = default(IList<MicrosoftDynamicsCRMfax>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> contactMailboxTrackingFolder = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMappointment> contactAppointments = default(IList<MicrosoftDynamicsCRMappointment>), MicrosoftDynamicsCRMsystemuser owninguser = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMasyncoperation> contactAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), MicrosoftDynamicsCRMprincipal ownerid = default(MicrosoftDynamicsCRMprincipal), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency), IList<MicrosoftDynamicsCRMrecurringappointmentmaster> contactRecurringAppointmentMasters = default(IList<MicrosoftDynamicsCRMrecurringappointmentmaster>), IList<MicrosoftDynamicsCRMbulkdeletefailure> contactBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), MicrosoftDynamicsCRMcontact parentcustomeridContact = default(MicrosoftDynamicsCRMcontact), IList<MicrosoftDynamicsCRMcontact> contactCustomerContacts = default(IList<MicrosoftDynamicsCRMcontact>), IList<MicrosoftDynamicsCRMconnection> contactConnections2 = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMduplicaterecord> contactDuplicateBaseRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMemail> contactEmails = default(IList<MicrosoftDynamicsCRMemail>), IList<MicrosoftDynamicsCRMactivityparty> contactActivityParties = default(IList<MicrosoftDynamicsCRMactivityparty>), IList<MicrosoftDynamicsCRMletter> contactLetters = default(IList<MicrosoftDynamicsCRMletter>), IList<MicrosoftDynamicsCRMrraApplication> rraContactRraApplicationContact = default(IList<MicrosoftDynamicsCRMrraApplication>))
        {
            ...
            RraContactRraApplicationContact = rraContactRraApplicationContact;
            CustomInit();
        }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "rra_password")]
        public string RraPassword { get; set; }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "rra_contact_rra_application_Contact")]
        public IList<MicrosoftDynamicsCRMrraApplication> RraContactRraApplicationContact { get; set; }
