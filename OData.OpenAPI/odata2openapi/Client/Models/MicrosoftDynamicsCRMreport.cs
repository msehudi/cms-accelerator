...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMreport
    {
        ...
        /// Initializes a new instance of the MicrosoftDynamicsCRMreport class.
        /// </summary>
        public MicrosoftDynamicsCRMreport(bool? isscheduledreport = default(bool?), int? signaturemajorversion = default(int?), string solutionid = default(string), string description = default(string), string _owneridValue = default(string), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), string reportnameonsrs = default(string), int? signaturelcid = default(int?), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string bodytext = default(string), string reportid = default(string), string iscustomizable = default(string), bool? ispersonal = default(bool?), string customreportxml = default(string), bool? iscustomreport = default(bool?), string schedulexml = default(string), string _owningteamValue = default(string), string mimetype = default(string), string _createdbyValue = default(string), string filename = default(string), int? languagecode = default(int?), string signatureid = default(string), int? reporttypecode = default(int?), string bodyurl = default(string), string defaultfilter = default(string), string _owninguserValue = default(string), string originalbodytext = default(string), string _createdonbehalfbyValue = default(string), int? signatureminorversion = default(int?), int? filesize = default(int?), int? componentstate = default(int?), int? timezoneruleversionnumber = default(int?), int? rdlhash = default(int?), string _modifiedonbehalfbyValue = default(string), System.DateTimeOffset? signaturedate = default(System.DateTimeOffset?), string queryinfo = default(string), string _modifiedbyValue = default(string), string introducedversion = default(string), string versionnumber = default(string), string bodybinary = default(string), byte[] bodybinaryBinary = default(byte[]), string reportidunique = default(string), string _owningbusinessunitValue = default(string), bool? ismanaged = default(bool?), string _parentreportidValue = default(string), int? utcconversiontimezonecode = default(int?), int? createdinmajorversion = default(int?), string name = default(string), IList<MicrosoftDynamicsCRMasyncoperation> reportAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMreportcategory> reportReportcategories = default(IList<MicrosoftDynamicsCRMreportcategory>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMprocesssession> reportProcessSessions = default(IList<MicrosoftDynamicsCRMprocesssession>), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMsyncerror> reportSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), MicrosoftDynamicsCRMprincipal ownerid = default(MicrosoftDynamicsCRMprincipal), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMbusinessunit owningbusinessunit = default(MicrosoftDynamicsCRMbusinessunit), MicrosoftDynamicsCRMreport parentreportid = default(MicrosoftDynamicsCRMreport), IList<MicrosoftDynamicsCRMreport> reportParentReport = default(IList<MicrosoftDynamicsCRMreport>))
        {
