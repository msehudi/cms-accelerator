...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMtimezonelocalizedname
    {
        ...
        /// MicrosoftDynamicsCRMtimezonelocalizedname class.
        /// </summary>
        public MicrosoftDynamicsCRMtimezonelocalizedname(string _timezonedefinitionidValue = default(string), string daylightname = default(string), string userinterfacename = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string timezonelocalizednameid = default(string), string standardname = default(string), string _createdonbehalfbyValue = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string _modifiedonbehalfbyValue = default(string), string _modifiedbyValue = default(string), string _createdbyValue = default(string), string versionnumber = default(string), string _organizationidValue = default(string), int? cultureid = default(int?), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMtimezonedefinition timezonedefinitionid = default(MicrosoftDynamicsCRMtimezonedefinition), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser))
        {
