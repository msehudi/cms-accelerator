...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMappmodule
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMappmodule(string appmodulexmlmanaged = default(string), string eventhandlers = default(string), int? statuscode = default(int?), string uniquename = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), System.DateTimeOffset? publishedon = default(System.DateTimeOffset?), string configxml = default(string), string url = default(string), string appmoduleversion = default(string), string appmoduleidunique = default(string), int? clienttype = default(int?), string _modifiedonbehalfbyValue = default(string), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), int? navigationtype = default(int?), string versionnumber = default(string), string solutionid = default(string), bool? isdefault = default(bool?), string _createdonbehalfbyValue = default(string), bool? isfeatured = default(bool?), int? formfactor = default(int?), string _modifiedbyValue = default(string), bool? ismanaged = default(bool?), string introducedversion = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string welcomepageid = default(string), int? statecode = default(int?), string name = default(string), string webresourceid = default(string), string appmoduleid = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), int? componentstate = default(int?), string description = default(string), string _publisheridValue = default(string), string optimizedfor = default(string), string _createdbyValue = default(string), string _organizationidValue = default(string), int? importsequencenumber = default(int?), string descriptor = default(string), IList<MicrosoftDynamicsCRMrole> appmodulerolesAssociation = default(IList<MicrosoftDynamicsCRMrole>), MicrosoftDynamicsCRMsystemuser appmoduleModifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMappconfig> appmoduleAppconfig = default(IList<MicrosoftDynamicsCRMappconfig>), MicrosoftDynamicsCRMsystemuser appmoduleCreatedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMpublisher publisherAppmoduleAppmodule = default(MicrosoftDynamicsCRMpublisher), IList<MicrosoftDynamicsCRMappmodulecomponent> appmoduleAppmodulecomponent = default(IList<MicrosoftDynamicsCRMappmodulecomponent>), MicrosoftDynamicsCRMsystemuser appmoduleModifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser appmoduleCreatedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMorganization organizationAppmoduleAppmodule = default(MicrosoftDynamicsCRMorganization), IList<MicrosoftDynamicsCRMserviceplan> serviceplanAppmoduleAssociation = default(IList<MicrosoftDynamicsCRMserviceplan>), IList<MicrosoftDynamicsCRMappnotification> appmoduleAppnotificationApp = default(IList<MicrosoftDynamicsCRMappnotification>), IList<MicrosoftDynamicsCRMappaction> appmoduleAppactionAppmoduleid = default(IList<MicrosoftDynamicsCRMappaction>))
        {
            ...
            AppmoduleAppnotificationApp = appmoduleAppnotificationApp;
            AppmoduleAppactionAppmoduleid = appmoduleAppactionAppmoduleid;
            CustomInit();
        }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "appmodule_appnotification_app")]
        public IList<MicrosoftDynamicsCRMappnotification> AppmoduleAppnotificationApp { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "appmodule_appaction_appmoduleid")]
        public IList<MicrosoftDynamicsCRMappaction> AppmoduleAppactionAppmoduleid { get; set; }
