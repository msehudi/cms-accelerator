...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMsdkmessagefilter
    {
        ...
        /// MicrosoftDynamicsCRMsdkmessagefilter class.
        /// </summary>
        public MicrosoftDynamicsCRMsdkmessagefilter(bool? ismanaged = default(bool?), string sdkmessagefilterid = default(string), int? componentstate = default(int?), string _modifiedonbehalfbyValue = default(string), string secondaryobjecttypecode = default(string), string _sdkmessageidValue = default(string), int? customizationlevel = default(int?), bool? workflowsdkstepenabled = default(bool?), string solutionid = default(string), string introducedversion = default(string), string sdkmessagefilteridunique = default(string), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), string versionnumber = default(string), string _createdonbehalfbyValue = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string _organizationidValue = default(string), string primaryobjecttypecode = default(string), string _modifiedbyValue = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), int? restrictionlevel = default(int?), string _createdbyValue = default(string), string name = default(string), bool? iscustomprocessingstepallowed = default(bool?), bool? isvisible = default(bool?), int? availability = default(int?), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), IList<MicrosoftDynamicsCRMsdkmessageprocessingstep> sdkmessagefilteridSdkmessageprocessingstep = default(IList<MicrosoftDynamicsCRMsdkmessageprocessingstep>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsdkmessage sdkmessageid = default(MicrosoftDynamicsCRMsdkmessage), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser))
        {
            Ismanaged = ismanaged;
