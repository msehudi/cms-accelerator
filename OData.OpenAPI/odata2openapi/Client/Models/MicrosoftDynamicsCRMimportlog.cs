...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMimportlog
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMimportlog(string _importdataidValue = default(string), string _owneridValue = default(string), int? statecode = default(int?), string _modifiedonbehalfbyValue = default(string), int? statuscode = default(int?), string _createdonbehalfbyValue = default(string), string _importfileidValue = default(string), string additionalinfo = default(string), string headercolumn = default(string), string _owningteamValue = default(string), string errordescription = default(string), int? sequencenumber = default(int?), string _createdbyValue = default(string), string _owninguserValue = default(string), int? linenumber = default(int?), string importlogid = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string columnvalue = default(string), string _owningbusinessunitValue = default(string), string _modifiedbyValue = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), int? errornumber = default(int?), int? logphasecode = default(int?), MicrosoftDynamicsCRMbusinessunit owningbusinessunit = default(MicrosoftDynamicsCRMbusinessunit), MicrosoftDynamicsCRMsystemuser owninguser = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMbulkdeletefailure> importLogBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), MicrosoftDynamicsCRMimportdata importdataid = default(MicrosoftDynamicsCRMimportdata), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMteam owningteam = default(MicrosoftDynamicsCRMteam), IList<MicrosoftDynamicsCRMasyncoperation> importLogAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), MicrosoftDynamicsCRMimportfile importfileid = default(MicrosoftDynamicsCRMimportfile), MicrosoftDynamicsCRMprincipal ownerid = default(MicrosoftDynamicsCRMprincipal), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser))
        {
