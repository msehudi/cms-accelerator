...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMaudit
    {
        ...
        /// Initializes a new instance of the MicrosoftDynamicsCRMaudit class.
        /// </summary>
        public MicrosoftDynamicsCRMaudit(int? operation = default(int?), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), int? action = default(int?), string useradditionalinfo = default(string), string attributemask = default(string), string objecttypecode = default(string), string _callinguseridValue = default(string), string _regardingobjectidValue = default(string), string _objectidValue = default(string), string _useridValue = default(string), string transactionid = default(string), string auditid = default(string), MicrosoftDynamicsCRMsystemuser callinguserid = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser userid = default(MicrosoftDynamicsCRMsystemuser))
        {
            Operation = operation;
            Createdon = createdon;
            Action = action;
