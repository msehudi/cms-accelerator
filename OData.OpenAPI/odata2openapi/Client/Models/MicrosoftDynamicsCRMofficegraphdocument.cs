...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMofficegraphdocument
    {
        ...
        /// MicrosoftDynamicsCRMofficegraphdocument class.
        /// </summary>
        public MicrosoftDynamicsCRMofficegraphdocument(System.DateTimeOffset? createdtime = default(System.DateTimeOffset?), string documentid = default(string), string authornames = default(string), string modifiedby = default(string), string fileextension = default(string), string createdby = default(string), string readurl = default(string), int? viewcount = default(int?), string sitetitle = default(string), string title = default(string), string officegraphdocumentid = default(string), string _transactioncurrencyidValue = default(string), string documentpreviewmetadata = default(string), System.DateTimeOffset? modifiedtime = default(System.DateTimeOffset?), int? timezoneruleversionnumber = default(int?), string weblocationurl = default(string), System.DateTimeOffset? documentlastmodifiedon = default(System.DateTimeOffset?), string previewimageurl = default(string), int? rank = default(int?), string _createdonbehalfbyValue = default(string), string versionnumber = default(string), string _organizationidValue = default(string), string secondaryfileextension = default(string), int? querytype = default(int?), int? utcconversiontimezonecode = default(int?), string filetype = default(string), string siteurl = default(string), string _modifiedonbehalfbyValue = default(string), decimal? exchangerate = default(decimal?), string documentlastmodifiedby = default(string), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency))
        {
