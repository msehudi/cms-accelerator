...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMrecommendeddocument
    {
        ...
        /// MicrosoftDynamicsCRMrecommendeddocument class.
        /// </summary>
        public MicrosoftDynamicsCRMrecommendeddocument(System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string versionnumber = default(string), string _modifiedbyValue = default(string), string externaldocumentid = default(string), string fullname = default(string), int? filesize = default(int?), string _transactioncurrencyidValue = default(string), string iconclassname = default(string), string externalmodifiedby = default(string), string _organizationidValue = default(string), string readurl = default(string), string author = default(string), int? timezoneruleversionnumber = default(int?), decimal? exchangerate = default(decimal?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string title = default(string), string _createdbyValue = default(string), string location = default(string), string recommendeddocumentid = default(string), string filetype = default(string), int? utcconversiontimezonecode = default(int?), string source = default(string), string contenttype = default(string), string _createdonbehalfbyValue = default(string), string _modifiedonbehalfbyValue = default(string), string _regardingobjectidValue = default(string), string associatedrecordname = default(string), string absoluteurl = default(string), string editurl = default(string), string version = default(string), MicrosoftDynamicsCRMsystemuser createdbyname = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfbyname = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedbyname = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedonbehalfbyname = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyidname = default(MicrosoftDynamicsCRMtransactioncurrency))
        {
            Createdon = createdon;
