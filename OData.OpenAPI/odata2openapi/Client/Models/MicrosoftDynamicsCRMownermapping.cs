...
namespace CRM.Interface.Models
{
    ...
    public partial class MicrosoftDynamicsCRMownermapping
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMownermapping(string solutionid = default(string), string targetuservalueforsourcecrmuserlink = default(string), int? statuscode = default(int?), string introducedversion = default(string), string _modifiedonbehalfbyValue = default(string), string _targetsystemuseridValue = default(string), int? processcode = default(int?), int? statecode = default(int?), string ownermappingidunique = default(string), string sourceuservalueforsourcecrmuserlink = default(string), string targetsystemuserdomainname = default(string), int? componentstate = default(int?), string _importmapidValue = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string _createdbyValue = default(string), string _modifiedbyValue = default(string), string sourcesystemusername = default(string), System.DateTimeOffset? overwritetime = default(System.DateTimeOffset?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string _createdonbehalfbyValue = default(string), string ownermappingid = default(string), bool? ismanaged = default(bool?), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser targetsystemuserid = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMimportmap importmapid = default(MicrosoftDynamicsCRMimportmap))
        {
